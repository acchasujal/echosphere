...
export async function handleGetChallenges(_req: Request, res: Response, next: NextFunction) {
  try {
...
export async function handleCreateChallenge(req: Request, res: Response, next: NextFunction) {
  try {
