...
import { handleCreateEmployee, handleDeleteEmployee, handleGetEmployeeById, handleGetEmployees, handleUpdateEmployee, } from '../controllers/employee.controller.js';
const router = Router();
