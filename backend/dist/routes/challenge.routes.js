...
import { handleCreateChallenge, handleDeleteChallenge, handleGetChallengeById, handleGetChallenges, handleUpdateChallenge, } from '../controllers/challenge.controller.js';
const router = Router();
